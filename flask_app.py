...
app = Flask(__name__)
app.config["MAX_CONTENT_LENGTH"] = 16 * 1024  # Limit request body size to prevent DoS attacks via large uploads.
...
# Dashboard HTML template moved to templates/dashboard.html
